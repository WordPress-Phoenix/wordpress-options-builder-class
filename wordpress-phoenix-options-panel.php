...
class page extends container {
	...
	public function inline_styles_and_scripts() {
		ob_start(); ?>
		<style>
			.onOffSwitch-inner,.onOffSwitch-switch{transition:all .5s cubic-bezier(1,0,0,1)}.onOffSwitch{position:relative;width:110px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;margin-left:auto;margin-right:12px}input[type=checkbox].onOffSwitch-checkbox{display:none}.onOffSwitch-label{display:block;overflow:hidden;cursor:pointer;border:2px solid #EEE;border-radius:28px}.onOffSwitch-inner{display:block;width:200%;margin-left:-100%}.onOffSwitch-inner:after,.onOffSwitch-inner:before{display:block;float:left;width:50%;height:40px;padding:0;line-height:40px;font-size:17px;font-family:Trebuchet,Arial,sans-serif;font-weight:700;box-sizing:border-box}.cb,.save-all,.wpop-option.color_picker .iris-picker{float:right}.onOffSwitch-inner:before{content:"ON";padding-left:10px;background-color:#21759B;color:#FFF}.onOffSwitch-inner:after{content:"OFF";padding-right:10px;background-color:#EEE;color:#BCBCBC;text-align:right}.onOffSwitch-switch{display:block;width:28px;margin:6px;background:#BCBCBC;position:absolute;top:0;bottom:0;right:66px;border:2px solid #EEE;border-radius:20px}.onOffSwitch-checkbox:checked+.onOffSwitch-label .onOffSwitch-inner{margin-left:0}.onOffSwitch-checkbox:checked+.onOffSwitch-label .onOffSwitch-switch{right:0;background-color:#D54E21}.wpop-loader-wrapper{position:fixed;top:45%;right:45%;z-index:99999;display:none}.ball-clip-rotate-multiple{position:relative}.ball-clip-rotate-multiple>div{position:absolute;left:-20px;top:-20px;border:3px solid #cd1713;border-bottom-color:transparent;border-top-color:transparent;border-radius:100%;height:35px;width:35px;-webkit-animation:rotate .99s 0 ease-in-out infinite;animation:rotate 1s 0 ease-in-out infinite}.cb,.cb-wrap,.desc:after,.pwd-clear,.save-all,span.menu-icon,span.spacer{position:relative}.ball-clip-rotate-multiple>div:last-child{display:inline-block;top:-10px;left:-10px;width:15px;height:15px;-webkit-animation-duration:.33s;animation-duration:.33s;border-color:#cd1713 transparent;-webkit-animation-direction:reverse;animation-direction:reverse}@keyframes rotate{0%{-webkit-transform:rotate(0) scale(1);transform:rotate(0) scale(1)}50%{-webkit-transform:rotate(180deg) scale(.6);transform:rotate(180deg) scale(.6)}100%{-webkit-transform:rotate(360deg) scale(1);transform:rotate(360deg) scale(1)}}#wpopMain{background:#fff}#wpopOptNavUl{margin-top:0}.wpop-options-menu{margin-bottom:8em}#wpopContent{background:#F1F1F1;width:100%!important;border-top:1px solid #D8D8D8}.pure-g [class*=pure-u]{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif}.pure-form select{min-width:320px}.selectize-control{max-width:98.5%}.pure-menu-disabled,.pure-menu-heading,.pure-menu-link{padding:1.3em 2em}.pure-menu-active>.pure-menu-link,.pure-menu-link:focus,.pure-menu-link:hover{background:inherit}#wpopOptions header{overflow:hidden;max-height:88px}#wpopNav p.submit input{width:100%}#wpop{border:1px solid #D8D8D8;background:#fff}.opn a.pure-menu-link{color:#fff!important}.opn a.pure-menu-link:focus{box-shadow:none;-webkit-box-shadow:none}#wpopContent .section{display:none;width:100%}#wpopContent .section.active{display:inline-block}span.page-icon{margin:0 1.5vw 0 0}span.menu-icon{left:-.5rem}span.page-icon:before{font-size:2.5rem;position:relative;top:-4px;right:4px;color:#777}.clear{clear:both}.section{padding:0 0 5px}.section h3{margin:0 0 10px;padding:2vw 1.5vw}.section h4.label{margin:0;display:table-cell;border:1px solid #e9e9e9;background:#f1f1f1;padding:.33vw .66vw .5vw;font-weight:500;font-size:16px}.section li.wpop-option{margin:1rem 1rem 1.25rem}.twothirdfat{width:66.6%}span.spacer{display:block;width:100%;border:0;height:0;border-top:1px solid rgba(0,0,0,.1);border-bottom:1px solid rgba(255,255,255,.3)}li.even.option{background-color:#ccc}input[disabled=disabled]{background-color:#CCC}.cb{right:20px}.card-wrap{width:100%}.fullwidth{width:100%!important;max-width:100%!important}.wpop-head{background:#f1f1f1}.wpop-head>.inner{padding:1vw 1.5vw 0}.save-all{top:-48px}.desc{margin:.5rem 0 0 .25rem;font-weight:300;font-size:12px;line-height:16px;transition:all 1s ease;color:#888;-webkit-transition:all 1s ease;-moz-transition:all 1s ease;-o-transition:all 1s ease}.desc:after{display:block;width:98%;border-top:1px solid rgba(0,0,0,.1);border-bottom:1px solid rgba(255,255,255,.3)}.wpop-option input[type=text]{width:90%}input[data-assigned]{width:100%!important}.add-button{margin:3em auto;display:block;width:100%;text-align:center}.img-preview{max-width:320px;display:block;margin:0 0 1rem}.img-remove{border:2px solid #cd1713!important;background:#f1f1f1!important;color:#cd1713!important;box-shadow:none;-webkit-box-shadow:none;margin-left:1rem!important}.pwd-clear{margin-left:.5rem!important;top:1px}.pure-form footer{background:#f1f1f1;border-top:1px solid #D8D8D8}.pure-form footer div div>*{padding:1rem .33rem}.wpop-option .wp-editor-wrap{margin-top:.5rem}.wpop-option.color_picker input{width:50%}.cb-wrap{display:block;right:1.33vw;max-width:110px;margin-left:auto;top:-1.66rem}
		</style>
		<?php
		$css = ob_get_clean();
		ob_start(); ?>
		<script type="text/javascript">
			!function(t,o){"use strict";t.wp=t.wp||{},t.wp.hooks=t.wp.hooks||new function(){function t(t,o,i,n){var e,a,p;if(r[t][o])if(i)if(e=r[t][o],n)for(p=e.length;p--;)(a=e[p]).callback===i&&a.context===n&&e.splice(p,1);else for(p=e.length;p--;)e[p].callback===i&&e.splice(p,1);else r[t][o]=[]}function o(t,o,n,e,a){var p={callback:n,priority:e,context:a},c=r[t][o];c?(c.push(p),c=i(c)):c=[p],r[t][o]=c}function i(t){for(var o,i,n,e=1,a=t.length;a>e;e++){for(o=t[e],i=e;(n=t[i-1])&&n.priority>o.priority;)t[i]=t[i-1],--i;t[i]=o}return t}function n(t,o,i){var n,e,a=r[t][o];if(!a)return"filters"===t&&i[0];if(e=a.length,"filters"===t)for(n=0;e>n;n++)i[0]=a[n].callback.apply(a[n].context,i);else for(n=0;e>n;n++)a[n].callback.apply(a[n].context,i);return"filters"!==t||i[0]}var e=Array.prototype.slice,a={removeFilter:function(o,i){return"string"==typeof o&&t("filters",o,i),a},applyFilters:function(){var t=e.call(arguments),o=t.shift();return"string"==typeof o?n("filters",o,t):a},addFilter:function(t,i,n,e){return"string"==typeof t&&"function"==typeof i&&(n=parseInt(n||10,10),o("filters",t,i,n,e)),a},removeAction:function(o,i){return"string"==typeof o&&t("actions",o,i),a},doAction:function(){var t=e.call(arguments),o=t.shift();return"string"==typeof o&&n("actions",o,t),a},addAction:function(t,i,n,e){return"string"==typeof t&&"function"==typeof i&&(n=parseInt(n||10,10),o("actions",t,i,n,e)),a}},r={actions:{},filters:{}};return a}}(window),jQuery(document).ready(function(t){function o(){wp.hooks.addAction("wpopPreInit",a),wp.hooks.addAction("wpopInit",e),wp.hooks.addAction("wpopInit",r),wp.hooks.addAction("wpopInit",p),wp.hooks.addAction("wpopSectionNav",i),wp.hooks.addAction("wpopPwdClear",c),wp.hooks.addAction("wpopImgUpload",l),wp.hooks.addAction("wpopImgRemove",s),wp.hooks.addAction("wpopSubmit",n)}function i(o,i){i.preventDefault();var n=t(t(o).attr("href")).addClass("active"),e=t(t(o).attr("href")+"-nav").addClass("active wp-ui-primary opn");return window.location.hash=t(o).attr("href"),window.scrollTo(0,0),t(n).siblings().removeClass("active"),t(e).siblings().removeClass("active wp-ui-primary opn"),!1}function n(){t(".wpop-loader-wrapper").css("display","inherit")}function e(){(hash=window.location.hash)?t(hash+"-nav a").trigger("click"):t("#wpopNav li:first a").trigger("click")}function a(){t("html, body").animate({scrollTop:0})}function r(){"undefined"!=typeof iris&&t('[data-field="color_picker"]').iris({width:320,hide:!1})}function p(){t("[data-select]").selectize({allowEmptyOption:!1,placeholder:t(this).attr("data-placeholder")});t("[data-multiselect]").selectize({plugins:["restore_on_backspace","remove_button","drag_drop","optgroup_columns"]})}function c(o,i){i.preventDefault(),t(o).prev().val(null)}function l(o,i){i.preventDefault();var n=t(o).data();d||(d=wp.media.frames.wpModal||wp.media({title:n.title,button:{text:n.button},library:{type:"image"},multiple:!1}),d.on("select",function(){var i=d.state().get("selection").first().toJSON();if("object"==typeof i){var n=t(o).closest(".wpop-option");n.find('[type="hidden"]').val(i.id),n.find("img").attr("src",i.url).show(),t(o).attr("value","Replace "+t(o).attr("data-media-label")),n.find(".img-remove").show()}})),d.open()}function s(o,i){i.preventDefault();var n=confirm("Remove "+t(o).attr("data-media-label")+"?");if(n){var e=t(o).closest(".wpop-option"),a=e.find(".blank-img").html();e.find('[type="hidden"]').val(null),e.find("img").attr("src",a),e.find(".button-hero").val("Set Image"),t(o).hide()}}var d;o(),wp.hooks.doAction("wpopPreInit"),t("#wpopNav li a").click(function(t){wp.hooks.doAction("wpopSectionNav",this,t)}),wp.hooks.doAction("wpopInit"),t('input[type="submit"]').click(function(t){wp.hooks.doAction("wpopSubmit",this,t)}),t(".pwd-clear").click(function(t){wp.hooks.doAction("wpopPwdClear",this,t)}),t(".img-upload").on("click",function(t){wp.hooks.doAction("wpopImgUpload",this,t)}),t(".img-remove").on("click",function(t){wp.hooks.doAction("wpopImgRemove",this,t)}),t(".add-button").on("click",function(t){wp.hooks.doAction("wpopRepeaterAdd",this,t)})});	
		</script>
		<?php
		$js = ob_get_clean();
...
//		die( 'runn');
	...
	public function get_multisite_table( $blog_id ) {
		return '1' == $blog_id ? 'wp_options' : 'wp_' . $blog_id . '_options';
	}
}
...
class password extends input {
	public $input_type = 'password'; // how to use: echo $this->decrypt( get_option( $this->id ) );
...
class select extends option {
	...
	public function __construct( $i, $m ) {
		...
		$this->values = ( ! empty( $m['values'] ) ) ? $m['values'] : array();
...
class multiselect extends option {
	...
	public function get_html() {
		...
		foreach ( $ordered_vals as $key => $value ) {
			$selected = in_array( $key, $save ) ? 'selected="selected"' : '';
...
class toggle_switch extends checkbox {
	function __construct( $i, array $args = array() ) {
		parent::__construct( $i, $args );
...
class radio_buttons extends option {
	...
	public function __construct( $i, $c ) {
		...
		$this->values        = ( ! empty( $c['values'] ) ) ? $c['values'] : array();
	...
	public function get_html() {
		...
		foreach ( $this->values as $key => $value ) {
			$selectedVal = $this->get_saved() ? $this->get_saved() : $this->default_value;
...
class include_markup extends option {
	...
	public function __construct( $i, $v = array(), $m ) {
